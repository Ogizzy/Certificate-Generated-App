...
<head>
  ...
  <title>BESEVIC Cert | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{ asset('certificate/index')}}" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">BESEVIC Cert App</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('certificate.create')}}"><i class="fa fa-circle-o"></i> Create Certificate</a></li>
            <li><a href="{{ route('home')}}"><i class="fa fa-circle-o"></i> Generate Certificate</a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="https://besevic.com"> BESEVIC</a>.</strong> All rights
    reserved.
  </footer>
